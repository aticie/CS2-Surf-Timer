...
namespace UTIL {
	...
	template<typename... Args>
	CTimerHandle CreateTimer(f64 initialDelay, typename CTimer<Args...>::Fn fn, Args... args) {
	...
	// With options.
	template<typename... Args>
	CTimerHandle CreateTimerEx(f64 initialDelay, TimerOption_t opt, typename CTimer<Args...>::Fn fn, Args... args) {
